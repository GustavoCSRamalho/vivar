...
import 'package:profile_module/src/domain/usecases/remove_avatar_usecase.dart';
import 'package:profile_module/src/domain/usecases/update_user_profile_usecase.dart';
import 'package:profile_module/src/domain/usecases/upload_avatar_usecase.dart';
    ...
    try {
      ...
      if (_profile != null) {
        _profile = ProfileEntity(
          ...
          // businessesVisited: _profile!.businessesVisited,
